...
| Topic | File |
|-------|------|
| Python API conventions | [`.cursor/rules/python-standards.mdc`](../../rules/python-standards.mdc) |
| Scoped public API changes | [`.cursor/rules/workflow-guardrails.mdc`](../../rules/workflow-guardrails.mdc) |
| Test coverage expectations | [`.cursor/rules/testing-standards.mdc`](../../rules/testing-standards.mdc) |
| Demo-facing expectations | [`.cursor/rules/demos-standards.mdc`](../../rules/demos-standards.mdc) |
