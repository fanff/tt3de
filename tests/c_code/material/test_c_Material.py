...
class Test_ApplyMaterialMethod(unittest.TestCase):  
    def test_this(self):
        ...
        mb.add_material(mat2) # add a second material to check that there is a correct mapping
        ...
        self.assertEqual(canvas_list[0], list(range(8))) # because material here is the 1, mode 1 is debug
