...
class Test_PrimitiveBuilding(unittest.TestCase):
    ...
    def test_with_over_flow(self):
        ...
        for i in range(20):
            ...
            geom_buffer.add_triangle_to_buffer(tri_1_point_a, tri_1_point_b, tri_1_point_c, tri_1_uv_array, tri_1_node_id, tri_1_material_id)
    ...
    def test_create_simple(self):
        ...
        geom_buffer.add_point_to_buffer(point1_x, point1_y, point1_z, point1_uv_array, point1_node_id, point1_material_id)
        ...
        geom_buffer.add_triangle_to_buffer(tri_2_point_a, tri_2_point_b, tri_2_point_c, tri_2_uv_array, tri_2_node_id, tri_2_material_id)
