...
class TT3DPolygonFan(TT3DNode):
    ...
    def insert_in(self, rc:RustRenderContext, parent_transform:glm.mat4):
        ...
        rc.geometry_buffer.add_polygon_fan_3d(start_idx,len(self.vertex_list)-2, self.node_id,self.material_id,start_uv)
...
class TT3DPolygon(TT3DNode):
    ...
    def insert_in(self, rc:RustRenderContext, parent_transform:glm.mat4):
        ...
        #rc.geometry_buffer.add_line3d(start_idx, self.node_id, self.material_id, 0)
        #rc.geometry_buffer.add_line3d(start_idx+1, self.node_id, self.material_id, 0)
        rc.geometry_buffer.add_polygon_3d(start_idx,len(self.vertex_list)//3, self.node_id,self.material_id,start_uv)
...
class TT3DPoint(TT3DNode):
    ...
    def insert_in(self, rc:RustRenderContext, parent_transform:glm.mat4):
        ...
        rc.geometry_buffer.add_point(start_idx,start_uv, self.node_id,self.material_id)
