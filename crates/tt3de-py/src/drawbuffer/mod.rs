...
use std::sync::Arc;
use tt3de_core::drawbuffer::drawbuffer::*;
use tt3de_core::drawbuffer::glyphset::*;
...
fn material_parallelism_from_py(
    spec: Option<Option<usize>>,
) -> (Option<usize>, Option<Arc<ThreadPool>>) {
    match spec {
        None => {
            let n = 8;
...
impl DrawingBufferPy {
    ...
    fn set_canvas_cell(
        ...
        self.opaque_db
            .set_canvas_content(row, col, frontc, backc, glyph)
    }
